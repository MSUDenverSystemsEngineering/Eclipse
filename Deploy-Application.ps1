...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'eclipse' -CheckDiskSpace -PersistPrompt
		...
		New-Shortcut -Path "$envProgramData\Microsoft\Windows\Start Menu\Programs\eclipse.lnk C:\eclipse\eclipse.exe -vmargs -Dosgi.instance.area.default=C:\eclipse\workspace" -TargetPath "C:\eclipse\eclipse.exe" -IconLocation "C:\eclipse\eclipse.exe" -Description "eclipse"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'eclipse' -CloseAppsCountdown 60
		...
		Remove-File -Path "$envProgramData\Microsoft\Windows\Start Menu\eclipse.lnk"
		Remove-Folder -Path "C:\eclipse"
